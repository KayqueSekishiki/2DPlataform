...
public class UIInGameManager : Singleton<UIInGameManager>
{
    ...
    public TextMeshProUGUI uiTextKeys;
    public TextMeshProUGUI uiTextSpecialBullets;
    ...
    public void UpdateTextKeys(int i)
    {
        if (i < 0)
        {
            uiTextCoins.text = "X " + i + " How did you do it?";
    ...
    public void UpdateTextSpecialBullets(int i)
    {
        if (i < 0)
        {
            uiTextCoins.text = "X " + i + " How did you do it?";
